...
-- CreateEnum
CREATE TYPE "AuthOtpPurpose" AS ENUM ('LOGIN');

-- CreateEnum
CREATE TYPE "AuthOtpStatus" AS ENUM ('PENDING', 'VERIFIED', 'EXPIRED', 'CONSUMED');
...
CREATE TABLE "AuthOtpRequest" (
    ...
    CONSTRAINT "AuthOtpRequest_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "AuthOtpRequest_email_status_createdAt_idx" ON "AuthOtpRequest"("email", "status", "createdAt");

-- CreateIndex
CREATE INDEX "AuthOtpRequest_userId_status_createdAt_idx" ON "AuthOtpRequest"("userId", "status", "createdAt");
...
-- CreateIndex
CREATE INDEX "ReviewModeration_moderatorId_createdAt_idx" ON "ReviewModeration"("moderatorId", "createdAt");

-- AddForeignKey
ALTER TABLE "AuthOtpRequest" ADD CONSTRAINT "AuthOtpRequest_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ReviewModeration" ADD CONSTRAINT "ReviewModeration_moderatorId_fkey" FOREIGN KEY ("moderatorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
