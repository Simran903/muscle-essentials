...
export const metadata: Metadata = {
  title: "Cookie Policy · Muscle Essentials",
  description:
    "How Muscle Essentials uses cookies and similar technologies on our website.",
}
      ...
      <main className={pageMainClassName({ maxWidth: "7xl" })}>
        <header className="max-w-2xl pb-10">
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground sm:text-base">
            This policy explains how Muscle Essentials uses cookies and similar technologies when you
